...
function Footer() {
    return (
        ...
        <footer id='footer' class="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-full bg-blend-multiply mix-blend-multiply" src="/assets/images/TT.png" alt="" />

                        <p class="text-base leading-relaxed text-gray-600 mt-7">Discover a world where every journey tells a story, every destination becomes a memory, and every adventure awaits—let us guide you to unforgettable places..</p>

                        <ul class="flex items-center space-x-5 ml-9 mt-9">
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Services </a>
                            </li>

                            <li>
                                <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Trips </a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Website details </a>
                            </li>
                    ...
                    <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe to TravelMitra</p>
                ...
                <p class="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by TravelMitra</p>
            </div>
        </footer>  
    );
}
