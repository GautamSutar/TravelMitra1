...
//             <TextRenderer value="Welcome to TravekMitra's Margdarshak" size="xxx-large" />
//             <TextRenderer value="I'm Margdarshak, a chatbot that can help you with the queries related with your tour" direction={'l'} />
//         </Box>
//         <Box className="flex flex-col items-center justify-center">
