...
**Live Project:** [https://travel-mitra1-kw8x.vercel.app/](https://travel-mitra1-kw8x.vercel.app/)  
**GitHub Repository:** [https://github.com/GautamSutar/TravelMitra1.git](https://github.com/GautamSutar/TravelMitra1.git)
...
It offers two ways to plan:
1. **Plan by TravelMitra** – AI-assisted and automatically generated plans.  
2. **Plan by Yourself** – users can manually create and customize their own trips.
...
2. **Backend (Node.js + Express.js)** – Processes requests, authentication, and logic.  
3. **Database (MongoDB Atlas)** – Stores user profiles, destinations, and trip data.  
...
![Home Page](travel_and_tourism/public/assets/readme_image/homepage.png)

### 🧳 Category Page
> Explore attractions under categories like Historical, Religious, Shopping, Nature, and more.
![Category Page](travel_and_tourism/public/assets/readme_image/category.png)

### 🏨 Hotel Booking Page
> Search hotels, compare prices, and book your stay easily.
![Hotel Page](travel_and_tourism/public/assets/readme_image/hotel.png)

### 🎉 Events & Festivals
> Find cultural events and celebrations happening in your chosen city.
![Events Page](travel_and_tourism/public/assets/readme_image/events.png)

### 🎭 Hidden Gems
> Explore lesser-known local treasures and experiences.
![Hidden Gems Page](travel_and_tourism/public/assets/readme_image/hiddengems.png)

### 🌟 Famous Personalities
> Learn about the renowned personalities associated with the city.
![Famous Personalities Page](travel_and_tourism/public/assets/readme_image/personalities.png)
...
© 2025 TravelMitra | Built with using the MERN Stack
