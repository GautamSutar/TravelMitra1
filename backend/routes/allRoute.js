...
const {
  ...
  CreatePlace,
  DeleteAllPlace,
} = require("../controllers/categoryFind");
...
const {
  ...
  YourPlaces,
  checkPlaceTypes,
} = require("../controllers/budgetPlan");

const {
  addCommentAndRating,
  getPlaceWithComment_Rating,
  deleteCommentRating,
} = require("../controllers/commentRating_etc");
...
const {
  ...
  AllPersonality,
  DeleteIconic,
} = require("../controllers/iconicPersonality");
...
const {
  ...
  DeleteHiddenGems,
  Detail,
} = require("../controllers/hiddenGems");
